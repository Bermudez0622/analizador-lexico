...
import com.udistrital.syntax.CPPLexer;
import com.udistrital.syntax.CPPParser;
import com.udistrital.syntax.ErrorListener;
...
public class Input extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/font.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/equis.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 199,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (evt.getSource() == jButton1) {
            ...
            String fileName = "target/classes/test-files/" + name + ".cpp";
            ...
            try (Scanner reader = new Scanner(file)) {
                ...
                if (validateSyntax(input)) {
                    log.log(Level.INFO, "El archivo cumple con la sintaxis");
                } else {
                    log.log(Level.SEVERE, "El archivo NO cumple con la sintaxis");
                }
            ...
            Tokens.getAllTokens().entrySet().forEach(tokens -> {
                ...
                tokens.getValue()
                        .forEach(count -> System.out.printf("%-10s\t%-8s%n", count.getKey(), count.getValue()));
            });
            ...
            try {
                ...
                CPPLexer lexer = new CPPLexer(CharStreams.fromString(entrada));
    ...
    static private boolean validateSyntax(String input) throws IOException {
        return true;
    }
